 ...
 */
final class Version20230329125848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE i23_paniers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_user INTEGER NOT NULL, produit_quantites CLOB NOT NULL --(DC2Type:array)
        , CONSTRAINT FK_625719616B3CA4B FOREIGN KEY (id_user) REFERENCES i23_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
